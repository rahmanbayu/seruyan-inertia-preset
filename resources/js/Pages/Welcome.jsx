    ...
    return (
        <Guest>
            ...
            <div className='md:container md:mx-auto h-screen w-full md:h-[85vh] lg:w-[70%] lg:grid grid-cols-2 relative z-10 shadow-xl overflow-hidden lg:rounded-2xl'>
                <div className='h-full lg:h-auto dark:bg-gray-800 bg-white dark:bg-opacity-60 rounded-none md:rounded-2xl lg:rounded-r-none lg:rounded-l-2xl overflow-hidden flex items-center justify-center flex-col p-5 sm:p-10'>
                    <div className='flex items-center justify-center'>
                        <img src={logo} alt="Logo kabupaten seruyan" className='h-24 md:h-20' />
                    </div>
                    ...
                    <div className='w-full'>
                        <form onSubmit={submit} method='POST'>
                            <div className='relative'>
                                ...
                                {errors.email && <div className='mt-1 text-sm text-rose-500 break-words whitespace-normal'>{errors.email}</div>}
                            </div>
                            <div className=' mt-10'>
                                <div className='relative'>
                                ...
                                {errors.password && <div className='mt-1 text-sm text-rose-500 break-words whitespace-normal'>{errors.password}</div>}
                            </div>
