    ...
    return (
        <>
            ...
            <div className={`${modalState ? '' : 'translate-y-5 opacity-0 pointer-events-none'} transform transition-all duration-150 ease-in fixed inset-0 flex items-center justify-center z-20 pointer-events-none backdrop-blur-sm`}>
                <div className={`${modalState ? 'pointer-events-auto' : 'pointer-events-none'} border border-transparent dark:border-gray-800 bg-white dark:bg-gray-900 sm:w-[85%] md:w-1/2 rounded-2xl p-4 max-h-[90vh] overflow-y-auto text-sm shadow-xl`}>
                    <div className="flex items-center justify-between">
                        <h3 className="text-sm font-bold text-gray-700 dark:text-gray-200">Tambah User</h3>
                    ...
                    <div className="mt-6">
                        <form onSubmit={submit}>
                            <div className="grid grid-cols-2 gap-x-3">
                                <div>
                                    <label htmlFor="name" className="text-sm mb-1 flex items-center dark:text-gray-200">Nama <sup className="text-rose-500 dark:text-rose-400 text-base leading-none tracking-tighter">*</sup></label>
                                    <input type="text" id="name" name="name" value={data.name} onChange={e => setData('name', e.target.value)} className="px-2 py-1.5 outline-none dark:bg-transparent dark:border-gray-300 dark:focus:border-sky-400 dark:ring-0 dark:text-gray-300 focus:ring-2 ring-sky-200 w-full rounded border hover:border-sky-300 focus:border-sky-500" />
                                    {errors.name && <div className='mt-1 text-sm text-rose-500'>{errors.name}</div>}
                                </div>
                                <div>
                                    <label htmlFor="email" className="text-sm mb-1 flex items-center dark:text-gray-200">Email <sup className="text-rose-500 dark:text-rose-400 text-base leading-none tracking-tighter">*</sup></label>
                                    <input type="text" id="email" name="email" value={data.email} onChange={e => setData('email', e.target.value)} className="px-2 py-1.5 outline-none dark:bg-transparent dark:border-gray-300 dark:focus:border-sky-400 dark:ring-0 dark:text-gray-300 focus:ring-2 ring-sky-200 w-full rounded border hover:border-sky-300 focus:border-sky-500" />
                                    {errors.email && <div className='mt-1 text-sm text-rose-500'>{errors.email}</div>}
                                </div>
                            </div>
                            <div className="mt-5">
                                <label htmlFor="roles" className="text-sm mb-1 flex items-center dark:text-gray-200">Roles <sup className="text-rose-500 dark:text-rose-400 text-base leading-none tracking-tighter">*</sup></label>
                            ...
                            <div className="grid grid-cols-2 gap-x-3 mt-5">
                                <div>
                                    <label htmlFor="password" className="text-sm mb-1 flex items-center dark:text-gray-200">Password <sup className="text-rose-500 dark:text-rose-400 text-base leading-none tracking-tighter">*</sup></label>
                                    <input type="text" id="password" name="password" value={data.password} onChange={e => setData('password', e.target.value)} className="px-2 py-1.5 outline-none dark:bg-transparent dark:border-gray-300 dark:focus:border-sky-400 dark:ring-0 dark:text-gray-300 focus:ring-2 ring-sky-200 w-full rounded border hover:border-sky-300 focus:border-sky-500" />
                                    {errors.password && <div className='mt-1 text-sm text-rose-500'>{errors.password}</div>}
                                </div>
                                <div>
                                    <label htmlFor="password_confirmation" className="text-sm mb-1 flex items-center dark:text-gray-200">Password Confirmation <sup className="text-rose-500 dark:text-rose-400 text-base leading-none tracking-tighter">*</sup></label>
