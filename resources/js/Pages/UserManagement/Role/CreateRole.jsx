...
export default function CreateRole() {
    ...
    return (
        <>
            ...
            <div onClick={closeModal} className={`${modalState ? 'bg-opacity-30' : 'bg-opacity-0 pointer-events-none'} fixed inset-0 bg-black transition-all duration-150 z-20`}></div>
            ...
            <div className={`${modalState ? '' : 'translate-y-5 opacity-0 pointer-events-none'} transform transition-all duration-150 ease-in fixed inset-0 flex items-center justify-center pointer-events-none backdrop-blur-sm z-20`}>
                <div className={`${modalState ? 'pointer-events-auto' : 'pointer-events-none'} border border-transparent dark:border-gray-800 bg-white dark:bg-gray-900 sm:w-[85%] md:w-1/2 lg:w-[40%] rounded-2xl p-4 max-h-[90vh] overflow-y-auto text-sm shadow-xl`}>
                    <div className="flex items-center justify-between">
                        <h3 className="text-sm font-bold text-gray-700 dark:text-gray-200">Tambah Role</h3>
                    ...
                    <div className="mt-6">
                        <form onSubmit={submit}>
                            <div>
                                <label htmlFor="name" className="text-sm mb-1 flex items-center dark:text-gray-200">Nama <sup className="text-rose-500 text-base leading-none tracking-tighter">*</sup></label>
